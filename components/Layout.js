        ...
        <>
            ...
            <div className="mx-auto mt-12 justify-center px-5 pt-4 text-center text-[#ffffff] md:px-6 lg:mt-36 lg:px-8">
                <div className="roboto-regular mb-4 lg:mb-12">
                    ...
                    <div className="mb-4 mt-3 lg:mb-0 lg:mt-6">
                        <motion.p
                            initial="hidden"
                            animate="animate"
                            exit={{ opacity: 0 }}
          ...
          >
            ...
            <button className="rounded-md bg-[#303030] px-4 py-3 text-sm text-white lg:ml-[-9rem]">
              Get Early Access
                ...
                <div className="container relative left-1/2 top-1/2 mb-[10rem] h-[70%] w-[95%] translate-x-[-50%] translate-y-[30%] md:mb-[15rem] lg:mb-[37rem] lg:h-1/2 lg:w-2/3">
                    <motion.div
                        initial="hidden"
                        animate="animate"
                        exit={{ opacity: 0 }}
                ...
                <div className="flex flex-col lg:flex-row lg:items-center">
                    <div className="pr-[3rem] md:max-w-xl md:pr-[3rem] lg:max-w-3xl lg:pr-[7rem] xl:pr-[17rem]">
                        <h3 className="pb-3 text-2xl lg:pb-6 lg:text-4xl">
                            Lorem ipsum dolor sit amet venenatis non quis
                            fringilla est
                        </h3>
                        <p className="text-md pb-12 text-[#757575] lg:pb-0 lg:text-xl">
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit. Sed hendrerit vulputate odio, quis fringilla
                            est venenatis non. Nunc felis libero, auctor vel
                            tellus at, suscipit finibus tortor.
                        </p>
                    </div>
                    <div>
                        {/* <Image
